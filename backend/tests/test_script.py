...
""".strip()
        ...
        self.assertIn("NDJSON, ONE OBJECT PER LINE", prompt)
        ...
        self.assertIn('"type": "news"', prompt)
        self.assertIn('"type": "outro"', prompt)
        ...
        self.assertIn("professional = crisp/less filler", prompt)
        ...
        self.assertIn("EVERY claim must trace to a provided news item", prompt)
        self.assertIn("No invented stories", prompt)
        self.assertIn("One `news` segment per item in `news[]`, in order.", prompt)
        self.assertIn("or weather report", prompt)
        self.assertIn("Thanks for tuning in", prompt)
