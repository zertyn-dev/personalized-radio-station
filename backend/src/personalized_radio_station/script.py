...
def _build_prompt(
    ...
    return (
        ...
        "ElevenLabs TTS. A short pre-recorded station opening (greeting + "
        "filler) has ALREADY played before your segments — you don't write "
        "that. You pick up the mic from there and roll straight into the "
        "stories. The result must FEEL like a real DJ on air.\n\n"
        "Output JSON ONLY:\n"
        "{\n"
        '  "title": "Episode title",\n'
        '  "segments": [\n'
        ...
        "pre-recorded opening into the first story.\n\n"
        "OPENING (first news segment) — NATURAL DJ ROLL-IN:\n"
        "- The listener has just heard a short greeting (`You're tuned "
        "in. Welcome back.` or similar). Your first line picks up from "
        "there mid-thought, like a real DJ unmuting after a station ID.\n"
        ...
        "- DO NOT greet the listener again, DO NOT name the station, "
        "DO NOT say 'welcome' or 'good evening' — that work was already "
        "done by the pre-recorded opening.\n\n"
